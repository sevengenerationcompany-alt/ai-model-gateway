        ...
        try:
            async with httpx.AsyncClient() as client:
                response = await client.post(
                    ...
                    headers={
                        "Authorization": f"Bearer {self.models['openrouter'].api_key}",
        ...
        try:
            async with httpx.AsyncClient() as client:
                response = await client.post(
                    ...
                    headers={"Authorization": f"Bearer {self.models['huggingface'].api_key}"},
                    json={"inputs": prompt}
                )
